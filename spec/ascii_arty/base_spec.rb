...
describe AsciiArty::Base do
  describe '#new' do
    ...
    it "should create a new instance" do
      a = AsciiArty::Base.new ''
      a.should be_an_instance_of AsciiArty::Base
    end
  end

    it "should default to 'big'" do
      a = AsciiArty::Base.new 'test'
  ...
  describe "font switching" do
    context 'should set font if passed -f ' do
      before do
        @a = AsciiArty::Base.new 'test', '-f', 'chunky'
      end
    ...
    context 'should set font if passed --font' do
      before do
        @a = AsciiArty::Base.new 'test', '--font', 'chunky'
      end
  ...
  describe "#asciify" do
    it "should produce an output" do
      a = AsciiArty::Base.new 'hello world'
      a.output.should_not be_empty
    end
  end
end